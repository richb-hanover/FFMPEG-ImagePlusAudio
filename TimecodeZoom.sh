...
ffmpeg -i *.mp4 \
	...
	-vf "drawtext=text=${label}:               x=100:  y=1030: fontsize=48:fontcolor=white: box=1:boxcolor=gray, \
		drawtext=timecode='$start_time': r=30: x=1500: y=1030: fontsize=48:fontcolor=white: box=1:boxcolor=gray" \
   	-y \
   	"$outfile"
